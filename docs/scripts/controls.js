...
CONTROLS.callback.codeLength = function () {
	var value = parseInt(this.DOM.children.codeLength.value);
	codeLength = value;
...
CONTROLS.callback.codeComplexity = function () {
	var value = parseInt(this.DOM.children.codeComplexity.value);
...
CONTROLS.callback.slotCount = function () {
	var value = parseInt(this.DOM.children.slotCount.value);
	slotCount = value;
